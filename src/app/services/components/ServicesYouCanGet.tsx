...
export default function ServicesYouCanGet({ items }: ServicesYouCanGetProps) {
    return (
        <div className={`${PageLayout} grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6`}>
            <h1 className='col-span-full text-3xl font-bold text-center mb-8'> What You Get with Our Payroll Software</h1>

...
export default function ServicesYouCanGet({ items, mainTitle }: ServicesYouCanGetProps) {
    return (
        ...
        <div className={`${PageLayout} grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-self-center`}>
            <h1 className='col-span-full text-xl md:text-3xl font-bold text-left md:text-center mb-8'> {mainTitle} </h1>

...
export default function GetValue({ title, subtitle, cta, items }: GetValueProps) {
    return (
        <div className={`${PageLayout} bg-[#F2F4F8] md:px-8 h-auto grid grid-cols-1 md:grid-cols-3 gap-6 py-10 px-4 md:mx-8 mt-20`}>
            <div className='flex flex-col gap-4 md:gap-8 justify-self-start text-gray-900 md:col-span-2'>
                <h2 className='text-2xl font-semibold uppercase'>{subtitle}</h2>
